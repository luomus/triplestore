...
@WebServlet(urlPatterns = {"/taxonomy-editor/api/moveTaxonDialog/*"})
public class ApiMoveDialogServlet extends ApiBaseServlet {

	private static final long serialVersionUID = 2856235816107282318L;

	@Override
	protected ResponseData processGet(HttpServletRequest req, HttpServletResponse res) throws Exception {
		ResponseData responseData = initResponseData(req).setViewName("api-moveTaxonDialog");
