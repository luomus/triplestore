...
<div class="column">
	...
	<@portletHeader "Informal groups" />
		...
		<#if headerPrinted>
			...
			<p class="info">Setting this to yes means the groups listead above are no longer inherited from the parent taxon. If you set other groups explicitly to this taxon, the 'parent groups' are still inherited.</p> 
