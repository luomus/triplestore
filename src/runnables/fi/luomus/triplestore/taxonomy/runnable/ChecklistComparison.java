...
public class ChecklistComparison {
	...
	private static final String PREV_YEAR = "2025";
	private static final String LATEST_YEAR = "2026";
	...
	private static void compareChecklists() throws Exception {
		File latest = new File(FOLDER, "taxon-export.tsv");
		File previous = new File(FOLDER, "Liite1_Appendix1_Lajiluettelo2025_Checklist2025.txt");
