...
public class AlueellinenUhanalaisuus {
	...
	private static void doit() throws Exception {
		File f = new File("C:/esko-local/git/eskon-dokkarit/Taksonomia/punainen-kirja-2010-2015/2015/linnut_Alueellisesti uhanalaiset linnut 2015_julkaistu.txt");
		for (String line : FileUtils.readLines(f)) {
			...
			for (int i = 3; i < parts.length-1; i++) {
				...
				if (!statusId.equals(occurrence.getStatus())) {
